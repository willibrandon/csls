...
public sealed partial class DapArrayPagingTests
{
    ...
    public async Task ArrayReferenceOverloadsUseExactLoadedTypes()
    {
        ...
        await AssertScalarExplicitConversionAsync(
            ...
            "Csls.TestProcessHost.DebuggerImplicitConversionFixture." +
                "CompilerExplicitNullableTargetForDebugger(implicitConversion)",
            "41.5",
            "double?",
            expectExpandable: true).ConfigureAwait(false);
        await AssertScalarExplicitConversionAsync(
            ...
            "(double)populatedLiftedImplicitConversion",
            "Csls.TestProcessHost.DebuggerImplicitConversionFixture." +
                "CompilerExplicitNullableSourceForDebugger(populatedLiftedImplicitConversion)",
            "41.5",
            "double").ConfigureAwait(false);

        JsonElement emptyNullableSource = await ReadEvaluationAsync(
            client,
            frameId,
            "(double)emptyLiftedImplicitConversion",
            success: false,
            TestContext.CancellationToken).ConfigureAwait(false);
        Assert.Contains("value", Assert.IsInstanceOfType<string>(
            emptyNullableSource.GetProperty("message").GetString()),
            StringComparison.OrdinalIgnoreCase);
        JsonElement compilerEmptyNullableSource = await ReadEvaluationAsync(
            client,
            frameId,
            "Csls.TestProcessHost.DebuggerImplicitConversionFixture." +
                "CompilerExplicitNullableSourceForDebugger(emptyLiftedImplicitConversion)",
            success: false,
            TestContext.CancellationToken).ConfigureAwait(false);
        Assert.Contains("System.InvalidOperationException", Assert.IsInstanceOfType<string>(
            compilerEmptyNullableSource.GetProperty("message").GetString()),
        ...
        await AssertScalarExplicitConversionAsync(
            ...
            "(int?)explicitNumericResultSource",
            "Csls.TestProcessHost.DebuggerImplicitConversionFixture." +
                "CompilerExplicitNullableNumericResultForDebugger(explicitNumericResultSource)",
            "41",
            "int?",
            expectExpandable: true).ConfigureAwait(false);
        await AssertScalarExplicitConversionAsync(
            client,
            frameId,
            "(int?)populatedLiftedNumericResult",
            "Csls.TestProcessHost.DebuggerImplicitConversionFixture." +
                "CompilerExplicitLiftedNullableNumericResultForDebugger(" +
                "populatedLiftedNumericResult)",
            "41",
            "int?",
            expectExpandable: true).ConfigureAwait(false);
        await AssertExplicitConversionAsync(
            client,
            frameId,
            "(Csls.TestProcessHost.DebuggerExplicitLiftedNumericOverloadDestination)" +
                "liftedNumericOverloadSource",
            "Csls.TestProcessHost.DebuggerImplicitConversionFixture." +
        ...
        await AssertLiftedOperatorsAsync(
            client, frameId, nullableOperatorType).ConfigureAwait(false);
        ...
        JsonElement emptyLiftedNumericResultValue = await ReadEvaluationAsync(
            client,
            frameId,
            "(int?)emptyLiftedNumericResult",
            success: true,
            TestContext.CancellationToken).ConfigureAwait(false);
        Assert.AreEqual("null", emptyLiftedNumericResultValue.GetProperty("result").GetString());
        JsonElement compilerEmptyLiftedNumericResult = await ReadEvaluationAsync(
            client,
            frameId,
            "Csls.TestProcessHost.DebuggerImplicitConversionFixture." +
                "CompilerExplicitLiftedNullableNumericResultForDebugger(emptyLiftedNumericResult)",
            success: true,
            TestContext.CancellationToken).ConfigureAwait(false);
        Assert.AreEqual("null", compilerEmptyLiftedNumericResult.GetProperty("result").GetString());
        using (JsonDocument invalidated = await client.ReadMessageAsync(
            TestContext.CancellationToken).ConfigureAwait(false))
        {
            AssertEvent(invalidated.RootElement, "invalidated");
    ...
    private async Task AssignAndAssertConversionAsync(
        DapTestClient client,
        int frameId,
