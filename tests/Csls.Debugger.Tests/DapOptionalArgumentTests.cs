...
public sealed class DapOptionalArgumentTests : DapTestContext
{
    ...
    public async Task TypedDefaultsAssignOnlyToMatchingStructStorage()
    {
        ...
        foreach ((string expression, string expected) in new[]
        {
            ...
            ("FirstGenericListForDebugger(inheritedObject)", "81"),
            ("FirstGenericEnumerableForDebugger(constructed[0])", "81"),
            ("FirstGenericEnumerableForDebugger(inheritedObject)", "81"),
            ("FirstGenericEnumerableForDebugger(vector)", "41"),
            ("CompilerFirstGenericEnumerableForDebugger()", "41"),
            ("CompilerFirstGenericBaseForDebugger()", "81"),
            ("StructNumberGenericForDebugger(optionalStructs[0])", "41"),
            ("PreferNonGenericForDebugger(41)", "2"),
            ("CommonGenericForDebugger(41, 42)", "32"),
            ("CommonGenericForDebugger(41, 42L)", "64"),
            ("CommonGenericForDebugger(42L, 41)", "64"),
            ("CommonGenericForDebugger(inheritedObject, constructed[0])", "71"),
            ("CommonGenericForDebugger(constructed[0], inheritedObject)", "71"),
            ("CommonGenericForDebugger(inheritedObject, singletonObject, emptyObject)", "1"),
            ("CompilerCommonNumericForDebugger()", "64"),
            ("CompilerCommonReferenceForDebugger(inheritedObject, singletonObject, emptyObject)", "1"),
        ...
        foreach (string rejectedCall in new[]
        {
            ...
            "CommonGenericForDebugger(41, \"hello\")",
            "FirstGenericEnumerableForDebugger(ambiguousEnumerable)"
        })
        {
