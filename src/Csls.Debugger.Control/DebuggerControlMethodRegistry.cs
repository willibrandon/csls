...
internal static class DebuggerControlMethodRegistry
{
    ...
    internal static void Register(JsonRpc rpc, IDebuggerControlTarget target)
    {
        ...
        AddParameterObjectMethod(
            ...
            new Func<DebugDumpOpenRequest, CancellationToken, Task<DebugSessionSnapshot>>(
                target.OpenDumpAsync));
        rpc.AddLocalRpcMethod(
        ...
        AddParameterObjectMethod(
            ...
            new Func<DebugExecuteExpressionRequest, CancellationToken, Task<DebugEvaluateResult>>(
                target.ExecuteExpressionAsync));
        AddParameterObjectMethod(
            rpc,
