...
internal sealed partial class CslsMcpDebuggerExecutionTools
{
    ...
    [Description("Execute an explicitly qualified, parameterless instance method in the target. Requires agentControl and the exact stopGeneration; the method may have arbitrary side effects.")]
    public Task<ModelContextProtocol.Protocol.CallToolResult> ExecuteExpressionAsync(
        ...
        int frameId,
        [Description("Explicitly qualified, parameterless instance-method call.")]
        string expression,
