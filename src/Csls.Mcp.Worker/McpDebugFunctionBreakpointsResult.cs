...
/// <summary>
/// Returns one complete function-breakpoint replacement result.
/// </summary>
...
internal sealed record McpDebugFunctionBreakpointsResult(
    string DebugSession,
    long StopGeneration,
    IReadOnlyList<DebugFunctionBreakpointInfo> Breakpoints) : IMcpDebugSessionResult;
