...
/// <summary>
/// Identifies captured frame storage followed by a bounded chain of field and array element selections.
/// </summary>
...
/// <param name="ParentId">The containing object or array handle, or zero for a frame value.</param>
/// <param name="ElementIndex">The flattened element position within the parent.</param>
/// <param name="Depth">The number of selections from the frame.</param>
/// <param name="Field">The exact field selection, or null for an array element or root.</param>
internal sealed record CorDebugDumpValuePath(uint ThreadId, ulong StackPointer, uint MethodToken,
    ...
    CorDebugDumpFieldSelection? Field = null);
