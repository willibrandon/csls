...
Explicit casts select exact loaded explicit or implicit conversion operators, require target-code
authorization, and can supply generation-safe direct assignment. Direct
