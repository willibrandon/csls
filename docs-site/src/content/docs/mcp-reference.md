...
| `debug_session_attach` | Destructive | None | `processId` required, `pause` | Attach an isolated debugger worker to one explicit managed process and return its debugSession identifier. |
